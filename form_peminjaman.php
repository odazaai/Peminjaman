        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="card mx-auto col-lg-6 ">
                    ...
                    <form action="proses_peminjaman.php" method="POST" name="peminjaman">
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tgl_kmbli" name="tgl_kmbli">
                        </div>
                        <div class="mb-3">
                            <label form="nama" class="form-label">No Identitas</label>
                            <input type="text" class="form-control" id="no_idn" name="no_idn">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kprl" name="kprl">
                        </div>
                        <div class="mb-3">
